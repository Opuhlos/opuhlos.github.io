    ...
    return(
        <nav className={`${notosans.className} ${styles.flexNav}`}>
            ...
            <div className={`${notosans.className} ${styles.menuDiv}`}>
                <div className={styles.menuOption}> <a href="art.html" className={styles.menuLink}>ART</a> </div>

                <div className={styles.menuOption}> <a href="projects.html" className={styles.menuLink}>PROJECTS</a> </div>
                
                <div className ={styles.menuOption}> <a href="contact.html" className={styles.menuLink}>CONTACT</a></div>
